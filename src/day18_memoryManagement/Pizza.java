...
public class Pizza {
public char size;// instance variable means it can be used many times

public int numberOfCheeseTopping, numberOfPepperoniTopping;
// calculates the total price of the pizza, and returns it as double
...
public double calcCost(){
    ...
    //toString is used for displaying it on console

  public void setInfo(char size, int numberOfCheeseTopping, int numberOfPepperoniTopping){// local variable
    this.size = size;

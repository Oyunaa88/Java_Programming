...
public class Phone {
    ...
    public Phone(String brand, String model, String size, String color, double price) {// this constructor cannot be inherited but child class has to call one of the constructor from parent class
        setBrand(brand);
        setModel(model);
        setSize(size);
        setPrice(price);
    ...
    public void setColor(String color) {
        ...
        if(Arrays.asList(colors).contains(color)) {
            ...
            System.err.println("Invalid color: " + color + "\ncolor of the phone can be: "+ Arrays.toString(colors) );
            System.exit(1);
        }
    }

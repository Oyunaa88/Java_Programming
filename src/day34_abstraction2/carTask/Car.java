...
public abstract class Car {
    ...
    protected final void stop(){// to make sure that non-sub classes outside package cannot access it
        System.out.println("Press the brake to stop " + make + model);
    }

    protected abstract void start(); // public and protected are only options

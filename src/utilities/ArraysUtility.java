...
public class ArraysUtility {
    ...
    public static int[] merge(int[] arr1, int[] arr2) {// returning int value

        int[] arr3 = new int[arr1.length + arr2.length];

        int k = 0; // to track the index number of the third array
    ...
    public static double[] merge(double[] arr1, double[] arr2) {// returning int value
    ...
    public static char[] merge(char[] arr1, char[] arr2) {// returning int value
    ...
    public static String[] merge(String[] arr1, String[] arr2) {// returning int value

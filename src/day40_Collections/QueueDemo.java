...
public class QueueDemo {
    public static void main(String[] args) {
        ...
        System.out.println(  ( (LinkedList)queue3).get(4)  );// LinkedList have index so it has get method
        ...
        // ( (Stack)list ).pop();   // LIFO doesn't work here because Stack doesn't have IS A relationship with queue

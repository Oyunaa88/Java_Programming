...
import day34_abstraction2.animalTask.*;
import day31_methodOverriding.Shape.Circle;
...
public class PolymorphismIntro {
    ...
    public static void main(String[] args) {
        ...
        Object[] employees = {teacher, developer, driver, tester};
         ...
         obj = new Driver("Aaron", 48, 'M', "D1", "Truck Driver", 90000);
        obj.work();
